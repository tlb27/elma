<template>
	<div class="header">
		...
		<div class="bulletin-wrapper">
			...
			<span class="bulletin-text" @click="showDetail(true)">{{seller.bulletin}}</span>
			<span class="icon-keyboard_arrow_right"></span>
		</div>
		...
		<transition name="fade">
			<div class="detail" v-show="detailShow"  ref="detailScroll">
				<div class="detail-wrapper">
					<div class="detail-main">
						...
						<ul class="supports">
							<li class="support" v-for="(support,index) of seller.supports">
								<span class="icon" :class="classMap[support.type]"></span>
								<span class="text" v-text="support.description"></span>
							</li>
						</ul>
						<div class="title">
							<div class="line"></div>
